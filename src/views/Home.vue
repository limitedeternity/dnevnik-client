                            ...
                            <ul class="collection">
                              <template v-for="(card, indexCard) in feedData.Feed.Days[0].MarkCards">
                                  <template v-for="(value, index) in card.Values">
                                      <li class="collection-item avatar z-depth-1" :key="`item-mark-${indexCard}-${index}`">
                                      ...
                                      <div :style="{display: 'block', clear: 'both', height: '2px'}" :key="`delimiter-mark-${indexCard}-${index}`"></div>
                                  </template>
                              </template>
                            </ul>
                            <div :style="{display: 'block', clear: 'both', height: '5px'}"></div>
